...
%==========================================================================
% check adjoint source time function
%
% [dcheck, dcheck_struct] = optlib_check_adjoint_stf(u, u0, du, t, src, rec, hpmin, hpmax, step, usr_par)
%==========================================================================
...
function [dcheck, dcheck_struct] = optlib_check_adjoint_stf(u, u0, du, t, src, rec, hpmin, hpmax, step, usr_par)
    ...
    [j, adj_stf(1,:)] = make_adjoint_sources(u, u0, t, usr_par.measurement.type, src, rec, usr_par.measurement.mode);
    ...
    for hp = hpmin:step:hpmax
        ...
        duh = u + 10 ^ hp * du;
        [jh] = make_adjoint_sources(duh, u0, t, usr_par.measurement.type, src, rec, usr_par.measurement.mode);
        jh_vec(it) = jh;
