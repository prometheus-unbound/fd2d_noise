...
% folder_1 = '~/Diss/RunCollection/fd2d_noise/inversion/data/';
% 
...
% rec = rec(rec_id,:);
% 
% % u.c_data(index,:) = 2 * (rand(1,length(u.t)) - 0.5);
% % u0.c_data(index,:) = 2 * (rand(1,length(u.t)) - 0.5);
% 
...
% 
% 
% [dcheck, dcheck_struct] = optlib_check_derivative_clean( m, reshape(dm,[],1), -10, 0, 1, usr_par );
% 
% return
% keyboard
% clear all
