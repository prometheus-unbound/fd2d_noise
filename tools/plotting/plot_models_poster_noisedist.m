...
%     c_data_1( c_data_1 > 4500 ) = 4499;
%     c_data_1( c_data_1 < 3500 ) = 3500;    
    
    set( h(1), 'CData', c_data_1 );
%     set( h(2), 'CData', pattern );
  
%     caxis([3500 5500])
%     set(cb,'Limits',[3500 4500])
%     set(cb,'YTick',[3500 4000 4500])
...
%     caxis([3900 4300])
%     set(cb,'Limits',[3900 4100])
%     set(cb,'YTick',[3900 4000 4100])
...
%     title('target velocity model', 'FontSize', title_size)
%     title('inverted velocity model', 'FontSize', title_size)
%     title('initial velocity model from traveltimes', 'FontSize', title_size)
%     title('traveltime velocity model', 'FontSize', title_size)
%     title('velocity model - moderate complexity', 'FontSize', title_size)
    title('velocity model - highest complexity', 'FontSize', title_size)
