...
% additionalSubmitArgs = sprintf('--partition=fichtner_compute --time=01-00:00:00 --nodes=8 --ntasks-per-node=2 --mem-per-cpu=16384 --ntasks=%d', props.NumberOfTasks);
% additionalSubmitArgs = sprintf('--partition=other_largemem --time=01-00:00:00 --nodes=2 --ntasks-per-node=8 --mem-per-cpu=8192 --ntasks=%d', props.NumberOfTasks);
% additionalSubmitArgs = sprintf('--partition=other_largemem --time=01-00:00:00 --nodes=4 --ntasks-per-node=4 --mem-per-cpu=16384 --ntasks=%d', props.NumberOfTasks);
